...
from trojsten.rules.kms_levels import (
...
class Command(BaseCommand):
    help = "Adds KMS level updates resulting from a camp or a semester."
        ...
        if options["camp_or_semester"] == "camp":
            ...
            rounds_with_semesters = (
                Round.objects.filter(
                    semester__competition__name="KMS", start_time__lte=camp.start_time
                )
