...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=trojsten.utils.utils.default_start_time,
                ...
                (
                    "visible",
                    models.BooleanField(default=False, verbose_name="vidite\u013enos\u0165"),
                ),
                (
                    "solutions_visible",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "Kateg\xf3ria", "verbose_name_plural": "Kateg\xf3rie"},
        ),
        migrations.CreateModel(
            name="Task",
            fields=[
                ...
                (
                    "description_points",
                    models.IntegerField(default=0, verbose_name="body za popis"),
                ),
                ("source_points", models.IntegerField(default=0, verbose_name="body za program")),
                (
                    "integer_source_points",
                    models.BooleanField(
                        default=True, verbose_name="celo\u010d\xedseln\xe9 body za program"
                    ),
                ),
                (
                    "has_source",
                    models.BooleanField(default=False, verbose_name="odovzd\xe1va sa zdroj\xe1k"),
                ),
                (
                    "has_description",
                    models.BooleanField(default=False, verbose_name="odovzd\xe1va sa popis"),
                ),
                (
                    "has_testablezip",
                    models.BooleanField(
                        default=False, verbose_name="odovzd\xe1va sa zip na testova\u010d"
                    ),
                ),
                (
                    "external_submit_link",
                    models.CharField(
                        blank=True,
                        max_length=128,
                        null=True,
                        verbose_name="Odkaz na extern\xe9 odovzd\xe1vanie",
                    ),
                ),
                (
                    "categories",
                    models.ManyToManyField(
                        blank=True, to="contests.Category", verbose_name="kateg\xf3ria"
                    ),
                ),
                (
                    "round",
            ...
            options={"verbose_name": "\xdaloha", "verbose_name_plural": "\xdalohy"},
        ),
