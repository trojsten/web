    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit_type', models.IntegerField(choices=[(0, b'source'), (1, b'description'), (2, b'testable_zip'), (3, b'external')], verbose_name='typ submitu')),
                ('points', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='body')),
                ('filepath', models.CharField(blank=True, max_length=512, verbose_name='s\xfabor')),
                ('testing_status', models.CharField(blank=True, max_length=128, verbose_name='stav testovania')),
                ('tester_response', models.CharField(blank=True, help_text='O\u010dak\xe1van\xe9 odpovede s\xfa CERR, TLE, WA, MLE, OK, IGN, SEC, EXC', max_length=10, verbose_name='odpove\u010f testova\u010da')),
