...
urlpatterns = [
    ...
    url(r'^ajax/submit/(?P<submit_id>\d+)/info.json$', views.poll_submit_info,
        name='poll_submit_info'),
    url(r'^ajax/submit/(?P<submit_id>\d+)/protokol/$', views.view_protocol,
        name='view_protocol'),
    url(r'^submit/(?P<submit_id>\d+)/$', views.view_submit, name='view_submit'),
    url(r'^protokol/upload/$', views.upload_protocol,
