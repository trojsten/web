...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'plugin_ksp_32_1_1_userlevel', (
        ...
        db.send_create_signal(u'plugin_ksp_32_1_1', ['UserLevel'])

        # Adding model 'Try'
        db.create_table(u'plugin_ksp_32_1_1_try', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userlevel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plugin_ksp_32_1_1.UserLevel'])),
        ...
        db.send_create_signal(u'plugin_ksp_32_1_1', ['Try'])


    def backwards(self, orm):
        # Deleting model 'UserLevel'
        db.delete_table(u'plugin_ksp_32_1_1_userlevel')

        # Deleting model 'Try'
        db.delete_table(u'plugin_ksp_32_1_1_try')
    ...
    models = {
        ...
        u'plugin_ksp_32_1_1.try': {
            ...
            'userlevel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['plugin_ksp_32_1_1.UserLevel']"})
        },
        u'plugin_ksp_32_1_1.userlevel': {
            'Meta': {'object_name': 'UserLevel'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_ksp_32_1_1']