...
def validate_url(value):
    ...
    raise ValidationError(
        "Hodnota by mala byť externá URL, absolútna cesta" + ' alebo urlname začínajúce znakom "@"!'
    )
...
class MenuItem(models.Model):
    ...
    url = models.CharField(
        ...
        help_text=(
            'Povolené tvary sú "http(s)://domain.com/path", ' + '"/absolute/path" a "@urlname".'
        ),
    )
...
class MenuGroup(models.Model):
    ...
    staff_only = models.BooleanField(default=False, verbose_name="iba pre vedúcich")
    ...
    items = SortedManyToManyField(MenuItem, related_name="groups", verbose_name="položky")
