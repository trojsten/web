...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submit.points'
        db.alter_column(u'tasks_submit', 'points', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Submit.points'
        db.alter_column(u'tasks_submit', 'points', self.gf('django.db.models.fields.IntegerField')())
