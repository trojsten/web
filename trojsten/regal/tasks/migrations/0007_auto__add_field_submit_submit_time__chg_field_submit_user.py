...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submit.submit_time'
        db.add_column(u'tasks_submit', 'submit_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 17, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Submit.user'
        db.alter_column(u'tasks_submit', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.User']))

    def backwards(self, orm):
        # Deleting field 'Submit.submit_time'
        db.delete_column(u'tasks_submit', 'submit_time')


        # Changing field 'Submit.user'
        db.alter_column(u'tasks_submit', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
