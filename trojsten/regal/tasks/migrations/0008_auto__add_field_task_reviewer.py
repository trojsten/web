...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.reviewer'
        db.add_column(u'tasks_task', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.reviewer'
        db.delete_column(u'tasks_task', 'reviewer_id')
    ...
    models = {
        ...
        u'contests.round': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 29, 0, 0)'}),
