...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submit.reviewer_comment'
        db.add_column(u'tasks_submit', 'reviewer_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submit.reviewer_comment'
        db.delete_column(u'tasks_submit', 'reviewer_comment')
    ...
    models = {
        ...
        u'contests.round': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 13, 0, 0)'}),
        ...
        u'tasks.submit': {
            ...
            'filepath': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'points': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'protocol_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'reviewer_comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'submit_type': ('django.db.models.fields.IntegerField', [], {}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tasks.Task']"}),
            'tester_response': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'testing_status': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
