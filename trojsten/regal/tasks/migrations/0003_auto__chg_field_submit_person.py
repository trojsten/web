...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submit.person'
        db.alter_column(u'tasks_submit', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Submit.person'
        db.alter_column(u'tasks_submit', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person']))
