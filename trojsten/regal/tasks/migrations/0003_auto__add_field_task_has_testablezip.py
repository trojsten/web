...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.has_testablezip'
        db.add_column(u'tasks_task', 'has_testablezip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.has_testablezip'
        db.delete_column(u'tasks_task', 'has_testablezip')
