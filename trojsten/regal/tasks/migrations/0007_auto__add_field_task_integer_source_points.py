...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.integer_source_points'
        db.add_column(u'tasks_task', 'integer_source_points',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.integer_source_points'
        db.delete_column(u'tasks_task', 'integer_source_points')
