...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventPlace.address'
        db.add_column(u'events_eventplace', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Address'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventPlace.address'
        db.delete_column(u'events_eventplace', 'address_id')
    ...
    models = {
        ...
        u'events.eventplace': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Address']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'events.eventtype': {
