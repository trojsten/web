    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_deadline', models.DateTimeField(null=True, verbose_name='deadline pre registr\xe1ciu', blank=True)),
                ('text', models.TextField(default='', help_text='Obsah bude prehnan\xfd <a href="http://en.wikipedia.org/wiki/Markdown">Markdownom</a>.', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('type', models.SmallIntegerField(default=0, verbose_name='typ pozv\xe1nky', choices=[(0, '\xfa\u010dastn\xedk'), (1, 'n\xe1hradn\xedk'), (2, 'ved\xfaci')])),
