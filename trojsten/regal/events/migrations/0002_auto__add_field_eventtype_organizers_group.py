...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventType.organizers_group'
        db.add_column(u'events_eventtype', 'organizers_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventType.organizers_group'
        db.delete_column(u'events_eventtype', 'organizers_group_id')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'list_of_participants': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'participating_event_set'", 'blank': 'True', 'to': u"orm['people.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
