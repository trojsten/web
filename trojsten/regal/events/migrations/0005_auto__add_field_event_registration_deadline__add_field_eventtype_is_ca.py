...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.registration_deadline'
        db.add_column(u'events_event', 'registration_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 26, 0, 0)),
                      keep_default=False)

        # Adding field 'EventType.is_camp'
        db.add_column(u'events_eventtype', 'is_camp',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.registration_deadline'
        db.delete_column(u'events_event', 'registration_deadline')

        # Deleting field 'EventType.is_camp'
        db.delete_column(u'events_eventtype', 'is_camp')
