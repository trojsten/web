...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRegistration.name'
        db.add_column(u'events_eventregistration', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRegistration.name'
        db.delete_column(u'events_eventregistration', 'name')
