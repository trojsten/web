...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventInvitation.invitation_type'
        db.delete_column(u'events_eventinvitation', 'invitation_type')

        # Adding field 'EventInvitation.type'
        db.add_column(u'events_eventinvitation', 'type',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EventInvitation.invitation_type'
        db.add_column(u'events_eventinvitation', 'invitation_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'EventInvitation.type'
        db.delete_column(u'events_eventinvitation', 'type')
