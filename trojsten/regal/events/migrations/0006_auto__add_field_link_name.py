...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.registration_deadline'
        db.alter_column(u'events_event', 'registration_deadline', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'Link.name'
        db.add_column(u'events_link', 'name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.registration_deadline'
        raise RuntimeError("Cannot reverse this migration. 'Event.registration_deadline' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Event.registration_deadline'
        db.alter_column(u'events_event', 'registration_deadline', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Link.name'
        db.delete_column(u'events_link', 'name')
    ...
    models = {
        ...
        u'events.event': {
            'Meta': {'ordering': "[u'-end_time', u'-start_time']", 'object_name': 'Event'},
        ...
        u'events.eventtype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_camp': ('django.db.models.fields.BooleanField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'people.userpropertykey': {
            'Meta': {'object_name': 'UserPropertyKey'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'sites.site': {
