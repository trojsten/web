...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'people_userproperty', ['user_id', 'key_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProperty', fields ['user', 'key']
        db.delete_unique(u'people_userproperty', ['user_id', 'key_id'])
    ...
    models = {
        ...
        u'people.userproperty': {
            'Meta': {'unique_together': "((u'user', u'key'),)", 'object_name': 'UserProperty'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'properties'", 'to': u"orm['people.UserPropertyKey']"}),
