...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'people_user', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'User.gender'
        db.alter_column(u'people_user', 'gender', self.gf('django.db.models.fields.CharField')(max_length=2))
