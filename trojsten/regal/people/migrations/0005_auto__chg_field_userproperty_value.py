...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProperty.value'
        db.alter_column(u'people_userproperty', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'UserProperty.value'
        db.alter_column(u'people_userproperty', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))
