...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPropertyKey'
        db.create_table(u'people_userpropertykey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'people', ['UserPropertyKey'])

        # Deleting field 'UserProperty.key'
        db.delete_column(u'people_userproperty', 'key')

        # Adding field 'UserProperty.key'
        db.add_column(u'people_userproperty', 'key',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['people.UserPropertyKey']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserPropertyKey'
        db.delete_table(u'people_userpropertykey')

        # Deleting field 'UserProperty.key'
        db.delete_column(u'people_userproperty', 'key_id')
    ...
    models = {
        ...
        u'people.userproperty': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.UserPropertyKey']"}),
