...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.start_time'
        db.add_column(u'contests_round', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.start_time'
        db.delete_column(u'contests_round', 'start_time')
