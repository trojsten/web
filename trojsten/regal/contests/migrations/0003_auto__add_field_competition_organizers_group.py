...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.organizers_group'
        db.add_column(u'contests_competition', 'organizers_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.organizers_group'
        db.delete_column(u'contests_competition', 'organizers_group_id')
