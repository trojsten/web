...
class AsciifoldingElasticBackend(es_backend.ElasticsearchSearchBackend):
    def __init__(self, *args, **kwargs):
        ...
        self.DEFAULT_SETTINGS["settings"]["analysis"]["analyzer"] = settings.ELASTICSEARCH_ANALYZER
    ...
    def build_schema(self, fields):
        ...
        for field_name, field_class in fields.items():
            ...
            if field_mapping["type"] == "string" and field_class.indexed:
                if not hasattr(field_class, "facet_for") and field_class.field_type not in (
                    "ngram",
                    "edge_ngram",
                ):
