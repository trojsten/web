...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrozenUserResult.prev_rank'
        db.add_column(u'results_frozenuserresult', 'prev_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FrozenUserResult.prev_rank'
        db.delete_column(u'results_frozenuserresult', 'prev_rank')
