...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FrozenResults.category'
        db.alter_column(u'results_frozenresults', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Category'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FrozenResults.category'
        raise RuntimeError("Cannot reverse this migration. 'FrozenResults.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FrozenResults.category'
        db.alter_column(u'results_frozenresults', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Category']))
    ...
    models = {
        ...
        u'contests.round': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)'}),
