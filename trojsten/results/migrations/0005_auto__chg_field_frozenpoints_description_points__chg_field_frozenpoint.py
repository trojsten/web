...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FrozenPoints.description_points'
        db.alter_column(u'results_frozenpoints', 'description_points', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'FrozenPoints.source_points'
        db.alter_column(u'results_frozenpoints', 'source_points', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'FrozenPoints.sum'
        db.alter_column(u'results_frozenpoints', 'sum', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'FrozenUserResult.sum'
        db.alter_column(u'results_frozenuserresult', 'sum', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'FrozenUserResult.previous_points'
        db.alter_column(u'results_frozenuserresult', 'previous_points', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'FrozenPoints.description_points'
        db.alter_column(u'results_frozenpoints', 'description_points', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'FrozenPoints.source_points'
        db.alter_column(u'results_frozenpoints', 'source_points', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'FrozenPoints.sum'
        db.alter_column(u'results_frozenpoints', 'sum', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'FrozenUserResult.sum'
        db.alter_column(u'results_frozenuserresult', 'sum', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'FrozenUserResult.previous_points'
        db.alter_column(u'results_frozenuserresult', 'previous_points', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'contests.round': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)'}),
        ...
        u'results.frozenpoints': {
            ...
            'description_points': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_points': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'sum': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        u'results.frozenuserresult': {
            ...
            'previous_points': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
