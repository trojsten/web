# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-27 22:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(blank=True, max_length=50, null=True, verbose_name='tag/kateg\xf3ria')),
                ...
                ('serialized_results', django.contrib.postgres.fields.jsonb.JSONField(blank=True)),
            ...
            options={
                ...
                'verbose_name_plural': 'V\xfdsledkovky',
            },
        ),
        migrations.AddIndex(
            model_name='results',
            index=models.Index(fields=['round', 'tag', 'is_single_round'], name='results_res_round_i_dd2339_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='results',
            unique_together=set([('round', 'tag', 'is_single_round')]),
        ),
    ]
