...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrozenResults.has_previous_results'
        db.add_column(u'results_frozenresults', 'has_previous_results',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FrozenResults.has_previous_results'
        db.delete_column(u'results_frozenresults', 'has_previous_results')
    ...
    models = {
        ...
        u'results.frozenresults': {
            ...
            'has_previous_results': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'results.frozenuserresult': {
            ...
            'prev_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
