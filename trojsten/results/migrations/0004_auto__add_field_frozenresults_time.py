...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrozenResults.time'
        db.add_column(u'results_frozenresults', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 12, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FrozenResults.time'
        db.delete_column(u'results_frozenresults', 'time')
    ...
    models = {
        ...
        u'contests.round': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 2, 0, 0)'}),
