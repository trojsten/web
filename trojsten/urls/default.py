...
urlpatterns = common_urlpatterns + [
    ...
    url(r'^archiv/$', trojsten.contests.views.archive, {'path': '/archiv'},
        name='archive'),
    url(r'^mojeulohy/$', trojsten.submit.views.all_submits_description_page, {'path': '/mojeulohy'},
        name='all_submits_description_page'),
    url(r'^mojesubmity/$', trojsten.submit.views.all_submits_source_page, {'path': '/mojesubmity'},
